...
- When FastGPT template files change, update `FASTGPT_TEMPLATE_CHANGELOG.md` by running `node scripts/js/record-fastgpt-template-changelog.ts --note "<summary>"` and commit the changelog with the template changes.
